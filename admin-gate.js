...
(function(){
  ...
  st.textContent=
    ...
    "#ag-gate input:focus{border-color:#C24A0C}"+
    "#ag-gate button{width:100%;height:46px;border:none;border-radius:11px;background:#C24A0C;color:#fff;"+
    ...
    "#ag-gate .m.e{color:#C62828;font-weight:700}"+
