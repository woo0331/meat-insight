...
--    계속 씁니다. admin-gate.js 로 Supabase 로그인을 요구하므로,
--    admins 표에 등록된 계정으로 들어가면 아래 정책이 수정·삭제를
--    허용합니다. 로그인하지 않으면 그때는 막힙니다 — 그게 목적입니다.
--    (admin.html 은 관리자 계정과 시세만 다룹니다. 위 세 화면을
--     대체하지 않습니다 — 예전 주석이 그렇게 적혀 있어 바로잡습니다.)
--
