...
window.WOW_PHOTOS = {
  /* ⚠️ 메인 히어로는 **배경이 아니라 오른쪽 칸**에 들어갑니다. 그래서
     납작한 띠(hero.svg)가 아니라 칸 비율에 맞춘 hero-home.svg 입니다.
     실제 현장 사진이 생기면 여기 경로만 바꾸세요. */
  /* ⚠️ 히어로 **바탕**에 까는 그림입니다. 글자가 왼쪽 60% 를 덮으므로
     볼 것이 오른쪽에 있는 납작한 띠(1600×620)여야 합니다 — 칸에 넣는
     hero(10:7)와 자르는 모양이 아예 다릅니다. 둘을 바꿔 쓰지 마세요. */
