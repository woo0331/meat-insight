...
window.WOW_BIZ = {
  ...
  /* ── 접수가 실제로 되는가 ────────────────────────────────
     ...
     ⚠️ **지금은 꺼져 있습니다 (2026-09-26).** Vercel 환경변수를 아직
     넣지 않으셨습니다 — 켜 두면 손님이 다 적고 눌렀는데 실패합니다.

     켜는 순서는 이렇습니다. **순서를 바꾸지 마세요.**
       ① Vercel → Settings → Environment Variables 에
          INTAKE_WEBHOOK_URL 하나, 또는 RESEND_API_KEY + INTAKE_EMAIL_TO
       ② Production 에 체크되어 있는지 확인
       ③ **다시 배포** (Vercel 은 떠 있는 함수에 값을 밀어 넣지 않습니다)
       ④ 실제 주소에서 SOS 를 한 번 넣어 보고 받을 곳에 도착하는지 확인
       ⑤ 도착하면 여기를 true 로 바꾸고, **같은 날**
          js/data/legal-privacy.js 의 trustees 에 그 회사를 한 줄 넣기
          (개인정보보호법 제26조 · 국외면 제28조의8) */
  sosReady:       false,
