...
window.WOW_BIZ = {
  ...
  /* ── 접수가 실제로 되는가 ────────────────────────────────
     ...
     ⚠️ **켜 두었습니다.** 접수가 안 되면 여기를 false 로 되돌리세요 —
     그러면 손님이 헛되이 적는 일은 없어집니다. 확인하는 법:
     실제 주소에서 SOS 를 한 번 넣어 보고 받을 곳에 도착하는지 봅니다.
     실패하면 화면에 "지금 접수하지 못했습니다" 토스트가 뜨고
     Vercel → Logs 에 무엇이 없는지 한 줄로 찍힙니다. */
  sosReady:       true,
