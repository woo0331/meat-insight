...
window.WOW_STARTUP_STEPS = [
  { key:"area",     name:"상권",       svc:null,        self:true,
    line:"어디서 할지. 여기서 틀리면 나머지가 다 소용없습니다." },
  { key:"shop",     name:"점포",       svc:null,        self:true,
    line:"평수 · 층 · 권리금 · 임대조건" },
  { key:"plan",     name:"사업계획",   svc:"consult",
    line:"메뉴 · 객단가 · 목표 매출 · 손익 계산" },
  { key:"interior", name:"인테리어",   svc:"interior",
    line:"고깃집은 환기와 동선이 먼저입니다" },
  { key:"duct",     name:"덕트 · 환기", svc:"duct",
    line:"민원의 대부분이 여기서 나옵니다" },
  { key:"kitchen",  name:"주방",       svc:"kitchen",
    line:"급배수 · 후드 · 가스 배관" },
  { key:"cold",     name:"냉장 · 냉동", svc:"cold",
    line:"워크인 · 쇼케이스 · 숙성고" },
  { key:"meatgear", name:"정육장비",   svc:"slicer",
    line:"육절기 · 골절기 · 진공기 · 저울" },
  { key:"table",    name:"테이블 · 로스터", svc:null,
    line:"좌석 수와 화구 수가 덕트 용량을 정합니다" },
  { key:"sign",     name:"간판",       svc:"sign",
    line:"옥외광고물 신고가 필요할 수 있습니다" },
  { key:"pos",      name:"POS",        svc:"pos",   line:"" },
  { key:"cctv",     name:"CCTV",       svc:"cctv",  line:"" },
  { key:"net",      name:"인터넷",     svc:"net",   line:"" },
  { key:"beef",     name:"육류 공급",  svc:"beef-supply",
    line:"거래처가 원가를 정합니다. 최소 세 곳은 비교하세요" },
  { key:"food",     name:"식자재",     svc:"food",  line:"" },
  { key:"drink",    name:"주류",       svc:"drink", line:"" },
  { key:"permit",   name:"인허가",     svc:null,    self:true,
    line:"영업신고 · 위생교육 · 소방 · 옥외광고물" },
  { key:"tax",      name:"세무 · 노무", svc:"tax",
    line:"사업자등록 · 4대보험 · 근로계약서" },
  { key:"market",   name:"마케팅",     svc:"marketing",
    line:"오픈 전에 시작해야 오픈 날 손님이 옵니다" },
  { key:"open",     name:"오픈준비",   svc:null,    self:true,
