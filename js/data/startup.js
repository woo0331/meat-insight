...
window.WOW_STARTUP_STEPS = [
  { key:"area", guide:"startup", icon:"pin", name:"상권",       svc:null,        self:true,
    line:"어디서 할지. 여기서 틀리면 나머지가 다 소용없습니다." },
  { key:"shop", guide:"startup", icon:"building", name:"점포",       svc:null,        self:true,
    line:"평수 · 층 · 권리금 · 임대조건" },
  { key:"plan", icon:"doc", name:"사업계획",   svc:"consult", post:"startup-cost-missing",
    line:"메뉴 · 객단가 · 목표 매출 · 손익 계산" },
  { key:"interior", guide:"interior", icon:"store", name:"인테리어",   svc:"interior",
    line:"고깃집은 환기와 동선이 먼저입니다" },
  { key:"duct", guide:"duct", icon:"fire", name:"덕트 · 환기", svc:"duct", post:"duct-smell-complaint",
    line:"민원의 대부분이 여기서 나옵니다" },
  { key:"kitchen", guide:"interior", icon:"tool", name:"주방",       svc:"kitchen",
    line:"급배수 · 후드 · 가스 배관" },
  { key:"cold", guide:"cold", icon:"snow", name:"냉장 · 냉동", svc:"cold", post:"aging-showcase",
    line:"워크인 · 쇼케이스 · 숙성고" },
  { key:"meatgear", guide:"equip", icon:"knife", name:"정육장비",   svc:"slicer",
    line:"육절기 · 골절기 · 진공기 · 저울" },
  { key:"table", guide:"interior", icon:"layers", name:"테이블 · 로스터", svc:null,
    line:"좌석 수와 화구 수가 덕트 용량을 정합니다" },
  { key:"sign", guide:"interior", icon:"bulb", name:"간판",       svc:"sign",
  ...
  { key:"beef", guide:"supply", icon:"truck", name:"육류 공급",  svc:"beef-supply", post:"change-meat-supplier",
    line:"거래처가 원가를 정합니다. 최소 세 곳은 비교하세요" },
  { key:"food", icon:"box", name:"식자재",     svc:"food",  line:"" },
  { key:"drink", icon:"box", name:"주류",       svc:"drink", line:"" },
  { key:"permit", guide:"startup", icon:"shield", name:"인허가",     svc:null,    self:true, post:"open-permits",
    line:"영업신고 · 위생교육 · 소방 · 옥외광고물" },
  { key:"tax", guide:"tax", icon:"doc", name:"세무 · 노무", svc:"tax", post:"labor-cost",
    line:"사업자등록 · 4대보험 · 근로계약서" },
  { key:"market", guide:"market", icon:"megaphone", name:"마케팅",     svc:"marketing", post:"delivery-vs-hall",
